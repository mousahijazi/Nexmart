...
export default async function LoginPage({searchParams}) { 
  ...
  return ( 
    <div className="min-h-screen flex items-center justify-center px-3 min-[480px]:px-6 min-[480px]:py-40"> 
      <div className="w-full max-w-5xl min-[480px]:bg-white min-[480px]:dark:bg-[#18221f] min-[480px]:rounded-3xl overflow-hidden min-[480px]:shadow-md grid md:grid-cols-2"> 
