...
export default function StatsSection() {
    ...
    const stats = [
        { label: "طلبات نشطة", value: activeOrdersCount },
        { label: "إجمالي الطلبات", value: totalOrdersCount },
        { label: "نقاط الولاء", value: user?.loyalty_points || 0 },
        { label: "قسائم متاحة", value: user?.coupons?.length || 0 },
    ];
    ...
    if (!user) {
        return <p className="py-8 text-center text-gray-500">Please log in to view this page.</p>;
    }
