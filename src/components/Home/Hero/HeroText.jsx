...
export default function HeroText() {
  return (
    <div className="flex flex-col items-start gap-4 sm:gap-6 lg:gap-8 max-w-2xl"> 
        <h1 className="pb-2 pt-1 bg-gradient-to-b from-[#5B3A21] dark:from-[#A68A64] dark:to-[#EDE0D4] to-[#A68A64] bg-clip-text text-transparent text-3xl min-[360px]:text-4xl sm:text-5xl lg:text-6xl xl:7xl font-extrabold flex flex-col gap-1.5">
