...
export default function HeroText() {
  ...
  return (
    <div className="flex flex-col items-start gap-4 sm:gap-6 lg:gap-8 max-w-2xl"> 
        <h1 className="pb-2 pt-1 bg-gradient-to-b from-[#83542F] to-[#C28B4D] bg-clip-text text-transparent md:drop-shadow-[0_3px_3px_rgba(0,0,0,0.45)] text-3xl min-[360px]:text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold">
          {t("home.hero.title")}
        </h1>
