...
export default function ProductsReviews({reviews}) {
  ...
  return (
    <div className="mt-16">
        <h1 className="text-2xl text-[#5B3A21] dark:text-[#F5EBE6] font-bold">{t("shop.products.reviews.title")}</h1>
        <div dir="ltr" className="mt-10 grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-12">
            {reviews.map((ele, index) => (
                <div key={index} className="flex flex-col gap-7 bg-[#fefefe] dark:bg-zinc-950 rounded-2xl pl-3 xl:pr-40 md:pr-32 sm:28 min-[480px]:pr-24 max-[480px]:pr-16 py-3 shadow-lg dark:shadow-black/90 hover:shadow-xl hover:-translate-y-3 transition duration-300">
                    <div>
